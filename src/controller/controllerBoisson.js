...
// l'export getData permet d'afficher les données contenu dans le fichier  boisson.json en json dan sla requete
...
exports.getData = (request, response) => {
  ...
  fs.readFile("./src/model/menu.json", (err, data) => {
    ...
    if (err) {
      ...
      response.status(200).json(JSON.parse(data).boisson);
    }
  });
};
...
exports.getDataById = (request, response) => {
  ...
  fs.readFile("./src/model/menu.json", (err, data) => {
    ...
    if (err) {
      ...
      const dataById = manipData.boisson.find(
...
exports.createData = (request, response) => {
  ...
  fs.readFile("./src/model/menu.json", (err, data) => {
    ...
    if (err) {
      ...
      existingData.boisson.push(request.body);
...
exports.updateData = (request, response) => {
  ...
  fs.readFile("./src/model/menu", (err, data) => {
    ...
    if (err) {
      ...
      const dataById = existingData.boisson.find(
        (obj) => obj.id === parseInt(request.params.id)
      );
  ...
  fs.readFile("./src/model/menu.json", (err, data) => {
    ...
    if (err) {
      ...
      if (!dataById) {
        ...
        existingData.boisson = existingData.boisson.filter(
          (obj) => obj.id != parseInt(request.params.id)
        );
        fs.writeFile(
          "./src/model/menu.json",
